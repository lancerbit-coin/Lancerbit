...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/lancerbit-cli.cpp \
           src/lancerbit-tx.cpp \
           src/lancerbit.cpp \
           src/db.cpp \
           ...
           src/qt/lancerbit.cpp \
           src/qt/lancerbitstrings.cpp \
...
RESOURCES += src/qt/lancerbit.qrc src/qt/lancerbit_locale.qrc

TRANSLATIONS += src/qt/locale/lancerbit_bg.ts \
                src/qt/locale/lancerbit_de.ts \
                src/qt/locale/lancerbit_en.ts \
                src/qt/locale/lancerbit_es.ts \
                src/qt/locale/lancerbit_fi.ts \
                src/qt/locale/lancerbit_fr.ts \
                src/qt/locale/lancerbit_it.ts \
                src/qt/locale/lancerbit_ja.ts \
                src/qt/locale/lancerbit_pl.ts \
                src/qt/locale/lancerbit_pt.ts \
                src/qt/locale/lancerbit_ru.ts \
                src/qt/locale/lancerbit_sk.ts \
                src/qt/locale/lancerbit_sv.ts \
                src/qt/locale/lancerbit_vi.ts \
                src/qt/locale/lancerbit_zh_CN.ts \
                src/qt/locale/lancerbit_zh_TW.ts
