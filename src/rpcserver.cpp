...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Lancerbit server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Lancerbit server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Lancerbit features */
        {"lancerbit", "masternode", &masternode, true, true, false},
        {"lancerbit", "masternodelist", &masternodelist, true, true, false},
        {"lancerbit", "mnbudget", &mnbudget, true, true, false},
        {"lancerbit", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"lancerbit", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"lancerbit", "mnsync", &mnsync, true, true, false},
        {"lancerbit", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"lancerbit", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use lancerbitd, or the -server option to lancerbit-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> lancerbit-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:3488/\n";
}
