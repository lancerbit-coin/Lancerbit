...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Lancerbit Core lancerbit-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  lancerbit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lancerbit transaction") + "\n" +
                               "  lancerbit-tx [options] -create [commands]   " + _("Create hex-encoded lancerbit transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded lancerbit transaction
