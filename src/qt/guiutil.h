...
/** Utility functions used by the Lancerbit Qt UI.
 */
namespace GUIUtil
{
...
// Render Lancerbit addresses in monospace font
...
// Parse "lancerbit:" URI into recipient object, return true on successful parsing
