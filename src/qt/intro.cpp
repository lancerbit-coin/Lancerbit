...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Lancerbit Core"),
     ...
     * override -datadir in the lancerbit.conf file in the default data directory
     * (to be consistent with lancerbitd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
