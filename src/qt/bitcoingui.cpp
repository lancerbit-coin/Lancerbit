                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Lancerbit Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    if (curStyle == "QWindowsStyle" || curStyle == "QWindowsXPStyle") {
        progressBar->setStyleSheet("QProgressBar { background-color: #F8F8F8; border: 1px solid grey; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: #A1A6C9, stop: 0 #00CCFF, stop: 1 #33CCFF); border-radius: 7px; margin: 0px; }");
    }
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Lancerbit address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lancerbit: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Lancerbit Core"), this);
    aboutAction->setStatusTip(tr("Show information about Lancerbit Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Lancerbit"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Lancerbit addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Lancerbit addresses"));
    ...
    openAction->setStatusTip(tr("Open a Lancerbit: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Lancerbit Core help message to get a list with possible Lancerbit command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Lancerbit Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Lancerbit network", "", count));
}
...
{
    QString strTitle = tr("Lancerbit Core"); // default title
